    ...
    <section className={'about-me'} id={'about-me'}>
      ...
      <div className={'about-me__container'}>
        <div className={'about-me__text-container'}>
          ...
          <a className={'link about-me__link'} href="https://github.com/andrey-goryachev" target={'_blank'} rel="noreferrer">Github</a>
        </div>
        <img className={'about-me__image'} src={imageStudentPath} alt="Фото студента"/>
      </div>
      <Portfolio />
    </section>
  );
